...
/**
 * أسماء غرف شائعة في البيوت هنا - **اقتراحٌ لا حصر**.
 *
 * رُفعت من `app/project/[id].tsx` حين احتاجها محرّر الشباك أيضًا: نسخُها
 * في ملفّين يعني قائمتين تتباعدان، وقائمةً تُترجَم إلى العبرية في وثيقة
 * الزبون وأخرى لا (المعجم في `quoteGlossary.ts` مبنيٌّ على هذه بالذات).
 */
