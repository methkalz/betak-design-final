...
const AR: QuoteStrings = {
  ...
  colMeters: 'الأمتار',
  colUnit: 'سعر المتر',
  // سطر البند مجموعُه، وأسفل الوثيقة السعر النهائي: كلمتان مختلفتان لمعنيين
  // مختلفين. كانتا «الإجمالي» كلتاهما فيقرأ الزبون الرقمين على أنهما شيء واحد.
  colTotal: 'المجموع',
  colWas: 'قبل',
  ...
  // بلا شدّة: العلامات التشكيلية تكسر وصل الحروف في الخط المضمَّن داخل
  // WebView الطباعة، فتظهر «وفّرت» مقطّعة. التشكيل اختياري والكلمة صحيحة بدونه.
  youSaved: 'وفرت',
  vat: 'الضريبة',
  grandInclVat: 'السعر النهائي شامل الضريبة',
  grand: 'السعر النهائي',
  note: 'ملاحظة',
  terms: 'الأسعار شاملة القياس والتركيب والتوصيل. التنفيذ يبدأ بعد اعتماد العرض ودفع الدفعة الأولى.',
  // بلا تنوين، لنفس سبب «وفرت» أعلاه
  thanks: 'شكرا لثقتكم',
  city: 'كفر مندا',
  sizeUnit: 'سم',
  metersUnit: 'م',
