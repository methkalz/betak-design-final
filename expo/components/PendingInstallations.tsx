    ...
    () =>
      db.projects.filter(
        (p) =>
          ...
          // مشاريعه هو، أو مشروع بلا عامل مسنَد - وإلا ظهرت له مشاريع غيره،
          // ولو اقتصرنا على المسنَد إليه لبقي المشروع اليتيم بلا من يجدوله
          (p.fieldWorkerId === currentUser?.id || !p.fieldWorkerId) &&
          !db.fieldVisits.some(
