-- ════════════════════════════════════════════════════════════════════
-- مرآة المحرك: بطانة بدرجتها وزيادتها، والمسار الكهربائي وملحقاته
--
-- النظير الحرفي لـ lineArithmetic في التطبيق: الزيادة وسعر المسار
-- الكهربائي يُضافان إلى سعر المتر الطولي قبل إسقاط الأغوروت، ومبالغ
-- الستارة (ماتور + جهاز تحكم، لكل ستارة لا لكل متر) تُضاف صحيحةً بعده.
-- اللقطات القديمة بلا هذه المفاتيح تقرأ صفرًا (coalesce) فتبقى النسخ
-- المقفلة والمتجهات الذهبية الثمانية كما هي حرفًا بحرف (§10).
-- واللقطة الجديدة تلتقط أسعار المكوّنات لتبقى مصدر المحرك الحصري.
-- ════════════════════════════════════════════════════════════════════
