-- ============================================================================
-- מע"מ يُضاف على السعر ولا يُستخرَج منه (قرار المالك 9.8.2026 - نقضَ ما قبله)
--
-- كانت الأسعار تُعدّ شاملةً للضريبة: يدفع الزبون 580 فيصل المحلَّ 491
-- والباقي للدولة. أي أن المحل كان يتحمّل الضريبة من سعره - فرقٌ يقارب
-- سُبع كل عرض سعر. الآن الأسعار قبل מע"מ: المجموع بعد الخصم هو الإيراد
-- كاملًا، والضريبة تُضاف عليه فيخرج ما يدفعه الزبون (580 + 104 = 684).
--
-- والضريبة تُسقط كسرها كغيرها (floor إلى الشيكل)، فيبقى المجموع صحيحًا
-- ولا يُحمَّل الزبون أغورةً لم تظهر في الحسبة. وأثره أن مبلغًا صغيرًا جدًا
-- قد تسقط ضريبته كلها - يتحمّلها المحل، وهو الاتجاه الآمن.
--
-- `vat_mode` في سياق التسعير يصير 'exclusive'. والنسخ القديمة تحتفظ
-- بسياقها 'inclusive' ولا تُمَس: المحتوى مجمّد بقرار §10 و، فما وُقّع
-- يبقى مقروءًا كما صدر.
--
-- الهامش يبقى مقيسًا على الإيراد قبل الضريبة - وهو الآن السعر نفسه - فترتفع
-- الهوامش المعروضة عمّا كانت: كانت مقيسة على 1/1.18 منه.
--
-- المتجهات الذهبية الثمانية أُعيد توليدها من المحرك في
-- `expo/domain/pricing.vectors.json`، وهي المرجع الذي يقيس عليه الطرفان.
-- ============================================================================
